"""
Django settings for bmw_sales_analytics project.
...
SECRET_KEY = 'django-insecure-ebn*v!mcrce0+vs84)zyi%cqp*_@#p5awjcxvcmz5y^%67zrir'
...
ROOT_URLCONF = 'bmw_sales_analytics.urls'
